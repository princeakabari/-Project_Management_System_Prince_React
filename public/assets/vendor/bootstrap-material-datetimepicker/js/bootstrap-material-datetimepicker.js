...
{this._attachEvent(this.$dtpElement.find('.dtp-btn-cancel'),'click',this._onCancelClick.bind(this));this._attachEvent(this.$dtpElement.find('.dtp-btn-ok'),'click',this._onOKClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onMonthBeforeClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onMonthAfterClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onYearBeforeClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onYearAfterClick.bind(this));this._attachEvent(this.$dtpElement.find('.dtp-actual-year'),'click',this._onActualYearClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onYearRangeBeforeClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onYearRangeAfterClick.bind(this));this._attachEvent(this.$dtpElement.find('../../../page-error-404.html'),'click',this._onYearItemClick.bind(this));if(this.params.clearButton===true)
...
{this.$dtpElement.find('../../../page-error-404.html').off('click').on('click',this._onSelectAM.bind(this));this.$dtpElement.find('../../../page-error-404.html').off('click').on('click',this._onSelectPM.bind(this));},initDate:function(d)
...
{var _template=this.constructHTMLCalendar(_date,_calendar);this.$dtpElement.find('../../../page-error-404.html').off('click');this.$dtpElement.find('.dtp-picker-calendar').html(_template);this.$dtpElement.find('../../../page-error-404.html').on('click',this._onSelectDate.bind(this));this.toggleButtons(_date);}
...
{this.$dtpElement.find('../../../page-error-404.html').click();}else
{this.$dtpElement.find('../../../page-error-404.html').click();}
...
svgClockElement.appendChild(svgHourCircle)
svgClockElement.appendChild(svgHourText)}
this.$dtpElement.find('../../../page-error-404.html').addClass('hidden');this.$dtpElement.find('../../../page-error-404.html').addClass('hidden');}
...
{var el=document.createElementNS('../../../../../www.w3.org/2000/svg.html',tag);for(var k in attrs)
...
{return this.$dtpElement.find('../../../page-error-404.html').hasClass('selected');},setElementValue:function()
...
{this.$dtpElement.find('../../../page-error-404.html').addClass('invisible');}else
{this.$dtpElement.find('../../../page-error-404.html').removeClass('invisible');}
...
{this.$dtpElement.find('../../../page-error-404.html').addClass('invisible');}else
{this.$dtpElement.find('../../../page-error-404.html').removeClass('invisible');}}},toggleTime:function(value,isHours)
...
{this.$dtpElement.find('../../../page-error-404.html').removeClass('selected');$(e.currentTarget).addClass('selected');this.selectDate($(e.currentTarget).parent().data("date"));if(this.params.switchOnClick===true&&this.params.time===true)
