...
this.container.find('.cancelBtn').addClass(this.cancelButtonClasses);this.container.find('.applyBtn').html(this.locale.applyLabel);this.container.find('.cancelBtn').html(this.locale.cancelLabel);this.container.find('.drp-calendar').on('../../page-error-404.html','.prev',$.proxy(this.clickPrev,this)).on('../../page-error-404.html','.next',$.proxy(this.clickNext,this)).on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.clickDate,this)).on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.hoverDate,this)).on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.monthOrYearChanged,this)).on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.monthOrYearChanged,this)).on('../../page-error-404.html','select.hourselect,select.minuteselect,select.secondselect,select.ampmselect',$.proxy(this.timeChanged,this))
this.container.find('.ranges').on('../../page-error-404.html','li',$.proxy(this.clickRange,this))
this.container.find('.drp-buttons').on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.clickApply,this)).on('../../page-error-404.html','../../page-error-404.html',$.proxy(this.clickCancel,this))
if(this.element.is('input')||this.element.is('button')){this.element.on({'../../page-error-404.html':$.proxy(this.show,this),'../../page-error-404.html':$.proxy(this.show,this),'../../page-error-404.html':$.proxy(this.elementChanged,this),'../../page-error-404.html':$.proxy(this.keydown,this)});}else{this.element.on('../../page-error-404.html',$.proxy(this.toggle,this));this.element.on('../../page-error-404.html',$.proxy(this.toggle,this));}
...
html+='</select>';}
this.container.find('.drp-calendar.'+side+' .calendar-time').html(html);},updateFormInputs:function(){if(this.singleDatePicker||(this.endDate&&(this.startDate.isBefore(this.endDate)||this.startDate.isSame(this.endDate)))){this.container.find('../../page-error-404.html').removeAttr('disabled');}else{this.container.find('../../page-error-404.html').attr('disabled','disabled');}},move:function(){var parentOffset={top:0,left:0},containerTop;var parentRightEdge=$(window).width();if(!this.parentEl.is('body')){parentOffset={top:this.parentEl.offset().top-this.parentEl.scrollTop(),left:this.parentEl.offset().left-this.parentEl.scrollLeft()};parentRightEdge=this.parentEl[0].clientWidth+this.parentEl.offset().left;}
if(this.drops=='up')
...
-containerWidth/2;if(containerLeft<0){this.container.css({top:containerTop,right:'auto',left:9});}else if(containerLeft+containerWidth>$(window).width()){this.container.css({top:containerTop,left:'auto',right:0});}else{this.container.css({top:containerTop,left:containerLeft,right:'auto'});}}else{var containerLeft=this.element.offset().left-parentOffset.left;if(containerLeft+containerWidth>$(window).width()){this.container.css({top:containerTop,left:'auto',right:0});}else{this.container.css({top:containerTop,left:containerLeft,right:'auto'});}}},show:function(e){if(this.isShowing)return;this._outsideClickProxy=$.proxy(function(e){this.outsideClick(e);},this);$(document).on('../../page-error-404.html',this._outsideClickProxy).on('../../page-error-404.html',this._outsideClickProxy).on('../../page-error-404.html','[data-toggle=dropdown]',this._outsideClickProxy).on('../../page-error-404.html',this._outsideClickProxy);$(window).on('../../page-error-404.html',$.proxy(function(e){this.move(e);},this));this.oldStartDate=this.startDate.clone();this.oldEndDate=this.endDate.clone();this.previousRightTime=this.endDate.clone();this.updateView();this.container.show();this.move();this.element.trigger('../../page-error-404.html',this);this.isShowing=true;},hide:function(e){if(!this.isShowing)return;if(!this.endDate){this.startDate=this.oldStartDate.clone();this.endDate=this.oldEndDate.clone();}
if(!this.startDate.isSame(this.oldStartDate)||!this.endDate.isSame(this.oldEndDate))
this.callback(this.startDate.clone(),this.endDate.clone(),this.chosenLabel);this.updateElement();$(document).off('.daterangepicker');$(window).off('.daterangepicker');this.container.hide();this.element.trigger('../../page-error-404.html',this);this.isShowing=false;},toggle:function(e){if(this.isShowing){this.hide();}else{this.show();}},outsideClick:function(e){var target=$(e.target);if(e.type=="focusin"||target.closest(this.element).length||target.closest(this.container).length||target.closest('.calendar-table').length)return;this.hide();this.element.trigger('../../page-error-404.html',this);},showCalendars:function(){this.container.addClass('show-calendar');this.move();this.element.trigger('../../page-error-404.html',this);},hideCalendars:function(){this.container.removeClass('show-calendar');this.element.trigger('../../page-error-404.html',this);},clickRange:function(e){var label=e.target.getAttribute('data-range-key');this.chosenLabel=label;if(label==this.locale.customRangeLabel){this.showCalendars();}else{var dates=this.ranges[label];this.startDate=dates[0];this.endDate=dates[1];if(!this.timePicker){this.startDate.startOf('day');this.endDate.endOf('day');}
...
this.showCalendars();}},clickApply:function(e){this.hide();this.element.trigger('../../page-error-404.html',this);},clickCancel:function(e){this.startDate=this.oldStartDate;this.endDate=this.oldEndDate;this.hide();this.element.trigger('../../page-error-404.html',this);},monthOrYearChanged:function(e){var isLeft=$(e.target).closest('.drp-calendar').hasClass('left'),leftOrRight=isLeft?'left':'right',cal=this.container.find('.drp-calendar.'+leftOrRight);var month=parseInt(cal.find('.monthselect').val(),10);var year=cal.find('.yearselect').val();if(!isLeft){if(year<this.startDate.year()||(year==this.startDate.year()&&month<this.startDate.month())){month=this.startDate.month();year=this.startDate.year();}}
